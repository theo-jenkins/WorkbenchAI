...
urlpatterns = [
    ...
    path('update_build_model_form/', views.update_build_model_form, name='update_build_model_form'),
    path('train_model_form/', views.train_model_form, name='train_model_form'),
    path('process_ticker_form/', views.process_ticker_form, name='process_ticker_form'),
]