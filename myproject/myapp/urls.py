...
from . import views
from .form_functions import update_process_data_form, update_build_model_form, update_select_model_form, update_sequential_model_form
...
urlpatterns = [
    ...
    path('select_model_form/', views.select_model_form, name='select_model_form'),
    path('update_select_model_form/', update_select_model_form, name='update_select_model_form'),
